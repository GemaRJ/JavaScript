...
// 1️. CONST → Constante (NO se puede modificar)
...
// 3️. VAR → Variable de ámbito global o de función (⚠️ No recomendable)
...
/*
VAR   → Global o función. Permite redeclarar y reasignar. ⚠️ Evitar su uso.
